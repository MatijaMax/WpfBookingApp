...
namespace BookingProject.View.GuideViewModel
{
    public class EnterRequestDateViewModel : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public bool IsGuideFree()
        {
            ...
            {
                if((instance.TourTime.StartingDateTime.Day== DateConversion.StringToDateTour(StartingDate).Day) && (instance.TourTime.StartingDateTime.Month == DateConversion.StringToDateTour(StartingDate).Month) && (instance.TourTime.StartingDateTime.Year == DateConversion.StringToDateTour(StartingDate).Year))
                {
                    return false;
                }
            }
